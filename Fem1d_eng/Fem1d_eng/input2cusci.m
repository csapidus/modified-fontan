...
uicontrol('Units','normalized',...
   ...
   'Style','Text',...
   'String','Insert the attributes of the numerical method',...
...
esegui=uicontrol('Units','normalized',...
   ...
   'CallBack','set(INFO,visible,ON);exe_cuscinetto; dis_cuscinetto;');
%
% Info
INFO=uicontrol('Units','normalized',...
   ...
   'CallBack','exe_cuscinetto; dis_cuscinetto;');
%
