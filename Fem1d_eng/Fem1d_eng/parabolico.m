...
FATHER(2)=figure('NumberTitle','off','Color',AQUAMARINE,...
   'Units','points',...
   'MenuBar','none','Name','Fem 1D: problema parabolico',...
...
uicontrol('Units','normalized',...
   ...
   'Style','Text',...
   'String',...
   'Choose the formulation and input the coefficents     : (costanti        )',...
...
MODUS=uicontrol('Units','normalized',...
   ...
   'Style','radiobutton','String','in modalità avanzata ',...
